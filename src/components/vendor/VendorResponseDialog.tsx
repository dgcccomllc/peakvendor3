...
import {
  ...
  interface IResponseDialogProps {
    ...
    costIds: string[],
    costs: ICost[] | undefined,
    onClose: () => void,
    onCommandClicked: (commandKey: string) => void
            ...
            <>
                ...
                >
                    <div className={contentStyles.header}>
                        <span id={titleId}>{currentCost.p15_companyid_name}</span>
                        <IconButton
                    ...
                    <div className={contentStyles.body}>
                        ...
                        <button onClick={() => setCurrentCostIndex(currentCostIndex + 1)}></button>
                        <p>
                    ...
                    <div className={contentStyles.footer}>
                        <CommandFooter onButtonClick={onCommandClicked} selectedCount={costIds.length} primaryButton={defaultButtonKey} footerMessage={(currentCostIndex + 1).toString() + ' of ' + costIds.length + ' Selected'}></CommandFooter>
                    </div>                    
                </Modal>
            </>
        )
